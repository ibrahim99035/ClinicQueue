...
from accounts.views import UserRegistrationView, UserLoginView, UserProfileView, UserListView, PatientProfileView, DoctorProfileView, AdminUserCreateView, PendingDoctorsListView, ApproveDoctorView
